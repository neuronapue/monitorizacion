...
console.log('Iniciando módulo agente de Javi.');

var http = require('http'), url = require('url'); //son librerias que tiene nodejs
var os = require('os');	

var ResumenEstadisticas = function (id, timestamp, memoriaLibre, memoriaTotal, usoCPUen60seg){
	this.id = id;
	this.timestamp = timestamp;
	this.memoriaLibre = memoriaLibre;
	this.memoriaTotal = memoriaTotal;
	this.usoCPUen60seg = usoCPUen60seg;
}
...
Agente.prototype.activar = function() {	
	...
	setInterval(function() {
		...
		if (contador % 10 == 0) {	//realizo el modulo para que se ejecute cada 60 sg.
			var resumen = new	ResumenEstadisticas (self.id, new Date().getTime(),os.freemem(), os.totalmem(), cpu);	// la función setinterval lo ejecuta JS. No puedo usar this pues me daría el del objeto global.
